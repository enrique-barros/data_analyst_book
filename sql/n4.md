...
## Ejercicio 3: Contar columna específica

**Enunciado:**
Escribe una consulta que cuente cuántos clientes diferentes han realizado pagos (contando los valores de `customerNumber` que no sean nulos).
...
**Explicación:**
`COUNT(columna)` cuenta el número de valores no nulos en esa columna. Si usamos `COUNT(customerNumber)`, contamos cuántos clientes hay en los pagos. Esto puede ser diferente de `COUNT(*)` si hay valores nulos.

</details>

---

## Ejercicio 4: Sumar todos los pagos
...
## Ejercicio 6: Obtener el pago máximo
...
## Ejercicio 7: Obtener el pago mínimo
...
## Ejercicio 9: Calcular el promedio de pagos
...
## Ejercicio 10: Promedio con alias
...
## Ejercicio 11: Todas las funciones de agregado juntas
...
## Ejercicio 12: COUNT en tabla products
...
## Ejercicio 13: SUM de cantidad en stock
...
## Ejercicio 14: MAX y MIN de cantidad en stock
...
## Ejercicio 15: AVG de cantidad en stock
...
## Ejercicio 20: Múltiples agregados con WHERE
...
## Ejercicio 21: COUNT de valores no nulos
...
## Ejercicio 22: Comparar COUNT(*) vs COUNT(columna)
...
## Ejercicio 23: MIN y MAX con WHERE
...
## Ejercicio 24: SUM y AVG comparación
...
## Ejercicio 25: Agregados con filtro complejo
