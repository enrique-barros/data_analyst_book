...
**Enunciado:**
Escribe una consulta que cuente cuántos clientes diferentes han realizado pagos (contando los valores de solo la columna `customerNumber`).
...
**Explicación:**
`COUNT(columna)` cuenta el número de valores en esa columna. Si usamos `COUNT(customerNumber)`, contamos cuántos clientes hay en los pagos.
