...
### Ejercicio 3: CASE con rangos numéricos
...
**Explicación:**
`GROUP BY` agrupa filas con el mismo `customerNumber`. `COUNT(*)` cuenta cuántos pedidos hay en cada grupo. Así obtenemos el número total de pedidos por cliente.
