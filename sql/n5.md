...
## Ejercicio 1: Redondear números con ROUND

**Enunciado:**
Escribe una consulta que muestre el nombre del producto (`productName`) y el precio de compra (`buyPrice`) redondeado a 2 decimales.
...
**Solución:**
```sql
SELECT productName, ROUND(buyPrice, 2) AS "Precio Redondeado" FROM products;
```

**Explicación:**
La función `ROUND(valor, decimales)` redondea un número a la cantidad de decimales especificados. En este caso, `ROUND(buyPrice, 2)` redondea el precio a 2 decimales. Si `buyPrice` es 15.3749, el resultado será 15.37.

</details>

---

## Ejercicio 2: ROUND sin especificar decimales

**Enunciado:**
Escribe una consulta que muestre el nombre del producto y el precio de compra redondeado al número entero más cercano (sin decimales).
...
**Solución:**
```sql
SELECT productName, ROUND(buyPrice) AS "Precio Entero" FROM products;
```

**Explicación:**
Cuando no especificamos el segundo parámetro, `ROUND()` redondea al número entero más cercano (decimales = 0). Si `buyPrice` es 15.6, el resultado será 16. Si es 15.4, el resultado será 15.

</details>

---

## Ejercicio 3: Redondear hacia arriba con CEIL
...
## Ejercicio 4: Redondear hacia abajo con FLOOR
...
## Ejercicio 5: Diferencia entre MSRP y buyPrice
...
## Ejercicio 6: Valor absoluto de desviaciones
...
## Ejercicio 7: MOD para obtener residuo
...
## Ejercicio 8: Convertir texto a mayúsculas
...
## Ejercicio 9: Convertir texto a minúsculas
...
## Ejercicio 10: Eliminar espacios en blanco con TRIM
...
## Ejercicio 11: Extraer parte del texto con SUBSTRING
...
## Ejercicio 12: SUBSTRING desde posición específica
...
## Ejercicio 13: Controlar nulos con COALESCE
...
## Ejercicio 14: COALESCE con múltiples valores
...
## Ejercicio 15: Combinación de funciones escalares
...
## Ejercicio 16: ROUND con agregado
...
## Ejercicio 18: SUBSTRING con LIKE
...
## Ejercicio 20: LOWER para normalizar búsquedas
