...
**Enunciado:**
Escribe una consulta sobre la tabla `offices` que muestre el código de oficina y la segunda línea de dirección (`addressLine2`), pero si es nula, muestre "Sin segunda dirección" en su lugar.
...
**Explicación:**
La función `COALESCE()` devuelve el primer valor que no sea nulo. Si `addressLine2` tiene un valor lo muestra, y si es nulo muestra "Sin segunda dirección". Es muy útil para manejar datos faltantes y garantizar que siempre haya un valor legible en los resultados.
