...
**Enunciado:**
Crea una consulta que muestre el nombre del cliente (`customerName`) y el apellido de contacto (`contactLastName`) de todos los clientes cuyo apellido de contacto comienza con la letra "S".
...
**Enunciado:**
Crea una consulta que muestre el nombre del cliente (`customerName`) y el país (`country`) de clientes que NO estén en "USA", "Canada" ni "Japón".
...
**Solución:**
```sql
SELECT customerName, country FROM customers WHERE country NOT IN ('USA', 'Canada', 'Japan');
```
...
| **_** | Comodín (un solo carácter) | Usado con LIKE |
| **LIMIT** | Limita número de resultados | `LIMIT 10` |
| **BETWEEN** | Filtra por un rango de valores | `amount BETWEEN 3000 AND 5000` |
